"""
This module contains the training logic for the InSkipConCNN model used in bone age prediction.

The train_InSkipConCNN function handles the complete training pipeline including data preparation,
...
def train_InSkipConCNN(
   ...
   """
   Train the InSkipConCNN model for bone age prediction.
